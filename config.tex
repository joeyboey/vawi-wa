...
\ifoot*{~
    \makebox[145mm][r]{
        \begin{minipage}[r]{200mm}
            \color{vawiblue}\rule{192mm}{2pt}\\[\dimexpr-\baselineskip+1mm+1.5pt]
            \color{vawilightblue}\rule{192mm}{2pt}
            \pagemark
        \end{minipage}
    }
    \hfill
    \begin{minipage}{1mm}
        \color{vawiblue}\rule{40mm}{2pt}\\[\dimexpr-\baselineskip+1mm+1.5pt]
        \color{vawilightblue}\rule{40mm}{2pt}
    \end{minipage}
}